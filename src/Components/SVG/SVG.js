...
export const HeartIcon = ({ isFill, onClick }) => {
  return (
    <svg
      aria-label="좋아요"
      fill={isFill ? '#ed4956' : '#262626'}
      height="24"
      viewBox="0 0 48 48"
      width="24"
      onClick={onClick}
...
export const CommentIcon = ({ isFill, onClick }) => {
  return (
    <svg
      aria-label="댓글 달기"
      fill="#262626"
...
export const ShareIcon = ({ isFill, onClick }) => {
  return (
    <svg
      aria-label="게시물 공유"
      fill="#262626"
...
export const BookmarkIcon = ({ isFill, onClick }) => {
  return (
    <svg
      aria-label="저장"
      fill="#262626"
...
export const SmileIcon = ({ isFill, onClick }) => {
  return (
    <svg
      aria-label="이모티콘"
      fill="#262626"
...
export const CloseIcon = ({ isFill, onClick }) => {
  return (
    <svg
      aria-label="닫기"
      class="_8-yf5 "
