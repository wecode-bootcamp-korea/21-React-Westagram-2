      ...
      <div className="feeds">
        <article>
          ...
          <div className="feeds-content">
            <span className="bold">jemizem</span> 인스타 그램 클론 코딩...{' '}
        ...
        <article>
          ...
          <div className="feeds-likes">
            ...
            <span className="profile-box-desc bold">cookie_is_love</span> 님 외
            239명이 좋아합니다.
          </div>
          <div className="feeds-content">
            <span className="bold">jemizem</span> 저희집 멍멍이 쿠키입니다 💖...{' '}
            <span className="gray more">더 보기</span>
          </div>
          <div className="feeds-comment-list">
